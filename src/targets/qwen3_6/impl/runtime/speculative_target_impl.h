...
void target_verify_accept(ExecutionCore& execution, Tensor& continuation_hidden_store,
    ...
    if (frame.feature_sink != nullptr) {
        card.target_verify_batch(
            frame.ids, frame.cache_positions, frame.rope_positions, frame.valid_columns,
            frame.kv_table_rows, frame.linear_state_read_slots,
            frame.linear_state_snapshot_base_slots, envelope, frame.target_hidden,
        ...
        card.target_verify_batch(frame.ids, frame.cache_positions, frame.rope_positions,
                                 ...
                                 frame.linear_state_read_slots,
                                 frame.linear_state_snapshot_base_slots, envelope,
    ...
    ops::scatter(frame.selected_hidden, frame.continuation_lanes, continuation_hidden_store,
