 ...
 * arbitrary N/K support. FP8 currently registers `[14336,5120]` at T=1. The current
 ...
 * LinearPolicy::A16Only and LinearPolicy::AllowA8. FP8 admits the same two policies at its T=1
 * registration; AllowA8 currently resolves to the qualified A16 route. NVFP4 admits A16Only and
 * AllowA4; AllowA4 permits the private resolver to select either a qualified A16 route or
